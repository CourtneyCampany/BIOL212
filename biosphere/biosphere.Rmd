...
* **Global climate depends on the amount of energy received by the sun and the amount of energy that is trapped in the system (e.g., atmosphere, living things).**
    + Different regions can have different climates.
    + Different regions may have seasons, where climate fluctuates

## 

<IMG STYLE="position:absolute; TOP:50px; LEFT:200px; WIDTH:700px; HEIGHT:600px" SRC="images/climate.png">
...
## Climate varies by latitude, with temperature &  seasons
<hr>
<br/>
