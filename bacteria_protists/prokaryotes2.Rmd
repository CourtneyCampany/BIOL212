...
* **Energy for ATP (without mitochondria)**
    + aerobic respiration= electron transport chain uses O~2~
    + anaerobic respiration = electron transport chain does not use O~2~
...
<IMG STYLE="position:absolute; TOP:160px; LEFT:700px; WIDTH:350px; HEIGHT:270px" SRC="images/iron.png">
...
* **Metabolism varies with respect to oxygen (reflects deep evolutionary history)**
    ...
    + harmed or killed by O~2~ for others
    + some can adjust based on presence/absence of O~2~
...
<IMG STYLE="position:absolute; TOP:420px; LEFT:500px; WIDTH:560px; HEIGHT:280px" SRC="images/photonitro.jpg">
...
## Rapid reproduction contributes to diversity via mutations
<hr>
...
<IMG STYLE="position:absolute; TOP:375px; LEFT:550px; WIDTH:500px; HEIGHT:300px" SRC="images/infant2.png">
...
<IMG STYLE="position:absolute; TOP:200px; LEFT:50px; WIDTH:1000px; HEIGHT:500px" SRC="images/conjugation.png">
...
<span style="color:purple"> **Banded iron formation (2.4 bya) the result of oxygen, dissolved iron and sea water**</span>
...
<IMG STYLE="position:absolute; TOP:50px; LEFT:50px; WIDTH:1000px; HEIGHT:600px" SRC="images/remediate.jpg">